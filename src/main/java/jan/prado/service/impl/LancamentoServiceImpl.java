...
import jan.prado.model.repository.LancamentoRepository;
import jan.prado.service.LancamentoService;
...
public class LancamentoServiceImpl implements LancamentoService {
    ...
    public void validar(Lancamento lancamento) {
        ...
        if(lancamento.getTipo() == null){
            throw new RegraNegocioException("Informe um tipo d elancamento");
        }
    }
}
